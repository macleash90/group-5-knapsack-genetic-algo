...
def select_chromosomes(population):
	...
	print("Selected 2 chromosomes for crossover")
...
def crossover(parent1, parent2):
	...
	print("Performed crossover between 2 chromosomes")
...
max_weight = 10
population_size = 10
mutation_probability = 0.2 #mostly set to 1/L, L being the bit string length 1/6 ~ .2
generations = 10
